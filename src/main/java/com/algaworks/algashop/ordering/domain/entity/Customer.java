...
import com.algaworks.algashop.ordering.domain.validator.FiledValidations;
...
public class Customer {
    ...
    public Customer(UUID id, String fullName, LocalDate birthDate, String email,
                    String phone, String document, Boolean promotionNotificationsAllowed, OffsetDateTime registeredAt) {
        this.setId(id);
    ...
    private void setEmail(String email) {
        FiledValidations.requiresValidEmail(email, VALIDATION_ERROR_EMAIL_IS_INVALID);
        this.email = email;
    }
